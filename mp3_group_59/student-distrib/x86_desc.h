...
#define KERNEL_CS   0x0010 //Kernel Code Segment: The KERNEL_CS segment specifies the code segment for kernel-level code
#define KERNEL_DS   0x0018 //Kernel Data Segment: The KERNEL_DS segment specifies the data segment for kernel-level data
#define USER_CS     0x0023 //User Code Segment: The USER_CS segment specifies the code segment for user-level code
#define USER_DS     0x002B //User Data Segment: The USER_DS segment specifies the data segment for user-level data
